...
int main() {
    ...
    while (T--) {
        ...
        l1 = a[1][2] == '1', l2 = a[2][1] == '1';
        r1 = a[n][n - 1] == '1', r2 = a[n - 1][n] == '1';
        if (l1 == l2) {
            std::cout << (r1 == l1) + (r2 == l1) << '\n';
            if (r1 == l1) std::cout << n << ' ' << n - 1 << '\n';
            if (r2 == l1) std::cout << n - 1 << ' ' << n << '\n';
        } else if (r1 == r2) {
            std::cout << 1 << '\n';
            if (l1 == r1) std::cout << 1 << ' ' << 2 << '\n';
            if (l2 == r1) std::cout << 2 << ' ' << 1 << '\n';
        } else {
            std::cout << 2 << '\n';
            std::cout << 2 << ' ' << 1 << '\n';
            if (r1 == l1) std::cout << n << ' ' << n - 1 << '\n';
