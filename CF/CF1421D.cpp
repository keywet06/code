// oct code object CF/CF1421B.cpp
#ifndef OCT_CODE_OBJECT_CFx2fCF1421Bx2eCPP
#define OCT_CODE_OBJECT_CFx2fCF1421Bx2eCPP
...
int T, x, y;
int64 q, t, ans, c1, c2, c3, c4, c5, c6;

inline void init() {
    while (q != c1 + c2 + c3 + c4 + c5 + c6) {
        q = c1 + c2 + c3 + c4 + c5 + c6;
        oct::mid(c1, c6 + c2), oct::mid(c2, c1 + c3), oct::mid(c3, c2 + c4);
        oct::mid(c4, c3 + c5), oct::mid(c5, c4 + c6), oct::mid(c6, c5 + c1);
    }
}
...
#endif  // oct code end CF/CF1421B.cpp
