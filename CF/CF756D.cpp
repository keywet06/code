#ifndef OCT_CODE_TITLE_CFx2fCF756Dx2eCPP // oct code object CF/CF756D.cpp
#define OCT_CODE_TITLE_CFx2fCF756Dx2eCPP
...
int main() {
    ...
    for (int i = 1; i < a.size(); ++i) {
        int tmp = 0;
        for (int c = 1; c <= C; c++) tmp = (tmp + dp[i][c]) % mod;
        ans = (ans + 1ll * r[n][i] * tmp % mod) % mod;
    }
    std::cout << ans << std::endl;
    return 0;
}

#endif // oct code end CF/CF756D.cpp
